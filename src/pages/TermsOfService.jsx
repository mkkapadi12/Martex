      ...
      <div className="container max-w-[1080px] mx-auto pt-[160px] xl:pt-[180px] pb-14 xl:pb-20 px-4 sm:px-14 lg:px-16 xl:px-4">
        ...
        <div className="space-y-16 leading-relaxed text-martex-light_text">
          ...
          <div className="text-[17px] md:text-[14px] xl:text-xl">
            ...
            <p className="">
              Donec sodales nibh vel (the <strong>"Terms"</strong>) aliquet
              tristique purus justo suscipit mauris tempus sed laoreet nulla
              ante purus. Donec dolor and magna undo suscipit magna at tortor
              laoreet dignissim, undo porttitor massa quisque and mollis, sapien
              gravida aliquet ipsum ultrices aliquet lorem purus and vitae auris
              aliquam.
            </p>
            <p className="mt-5">
          ...
          <div className="text-[17px] md:text-[14px] xl:text-xl">
            ...
            <p className="">
              Congue sagittis augue egestas integer velna purus purus magna nec
              suscipit and egestas magna aliquam ipsum vitae purus justo lacus
              ligula ipsum primis cubilia donec undo augue luctus vitae egestas
              a molestie donec libero sapien dapibus congue tempor undo quisque
